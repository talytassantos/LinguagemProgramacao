...
public class ClasseMetodos {
    public Aluno [] GravaAluno (Aluno[] aluno) throws IOException {
        ...
        for (i=0; i<3; i++){
            aluno[i].pnome = JOptionPane.showInputDialog("Digite o "
                    + "nome do aluno:");
            gravar.write(aluno[i].pnome);
            gravar.newLine();
            
            aluno[i].unome = JOptionPane.showInputDialog("Digite o "
                    + "sobrenome do aluno");
            gravar.write(aluno[i].unome);
            gravar.newLine();
            
            aluno[i].pontos = Integer.parseInt(JOptionPane.showInputDialog(""
                    + "Pontos:"));
    ...
    //Procedimento para ler registro
